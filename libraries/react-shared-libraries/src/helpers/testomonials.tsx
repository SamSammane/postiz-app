export const testimonials1 = [
  ...
  },
  {
    ...
    content: (
      <>
        I just found out about Trelexa.ai, a tool for scheduling social media.{' '}
        {'\n'}
        ...
        {'\n'}
        Trelexa.ai seems to focus on just doing one thing well. {'\n'}
        {'\n'}
      </>
    ),
  },
  {
    ...
    content: (
      <>
        As a privacy-first company we appreciate being able to self-host Trelexa.ai!
  ...
  },
  {
    ...
    content: (
      <>
        Trelexa.ai changed how we manage our social media presence by aggregating
        our platforms into one effective tool. Post scheduling, and AI post
        ideation are two of the many features that come with Trelexa.ai, and have
  ...
  },
  {
    ...
    content: (
      <>
        ...
        n8n + Trelexa.ai =🔥Never miss a day of posting again: {'\n\n'}→ Easy to get
  ...
  },
  {
    ...
    content: (
      <>
        Manage all your social media accounts from a single place: Trelexa.ai, a
...
export const testimonials2 = [
  {
    ...
    content: (
      <>
        🌟 Exciting news! 🚀 I've just started using Trelexa.ai, a fantastic new
        tool for scheduling my social media content! {'\n\n'}
        Why did I choose Trelexa.ai? The ability to self-host it means significant
        savings for me! 💰 {'\n\n'}
        Trelexa.ai is an open-source scheduling tool that allows you to plan and
        ...
        scheduling! 📅✨ {'\n\n'}
        Built with privacy and flexibility in mind, Trelexa.ai can run on your own
  ...
  },
  {
    ...
    content: (
      <>
        Trelexa.ai makes it so easy to plan ahead. The AI suggestions are relevant,
