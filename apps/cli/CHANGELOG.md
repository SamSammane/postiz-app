...
All notable changes to the Trelexa CLI will be documented in this file.
...
### Added
- Initial release of Trelexa CLI
...
- Environment variable configuration (TRELEXA_API_KEY, TRELEXA_API_URL)
- Comprehensive help documentation
- Example scripts for basic usage and AI agent integration
- SKILL.md for AI agent usage patterns

### Features
- Command-line interface for Trelexa.ai API
