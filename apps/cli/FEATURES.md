# Trelexa CLI - Feature Summary

## ✅ Complete Feature Set

### Posts with Comments and Media - FULLY SUPPORTED

The Trelexa CLI **fully supports** the complete API structure including:
...
trelexa posts:create -c "Post" --image "img1.jpg,img2.jpg,img3.jpg" -i "twitter-123"

# With comments (no custom media per comment)
trelexa posts:create -c "Main" --comments "Comment 1;Comment 2" -i "twitter-123"
```
...
- ✅ Fully compatible with the Trelexa.ai API structure

The CLI supports the **complete Trelexa.ai API** including all advanced features!
