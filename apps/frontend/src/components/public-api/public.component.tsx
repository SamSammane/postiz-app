    ...
    <div className="flex flex-col gap-[20px]">
      <div className="flex flex-col">
        ...
        <div className="text-customColor18 mt-[4px]">
          ...
          >
            <br />
            {t('check_n8n', 'Check out our N8N custom node for Trelexa.ai.')}
          </a>
        </div>
        <div className="flex flex-col">
      ...
      <div className="flex flex-col">
        <h3 className="text-[20px]">Building your Trelexa.ai payload</h3>
        <div className="text-customColor18 mt-[4px] whitespace-pre-line">
          ...
          We have created an easy way to build your Trelexa.ai payload to schedule
          posts. {'\n'}
          You can use the Trelexa.ai wizard, and schedule a post with our UI, after
