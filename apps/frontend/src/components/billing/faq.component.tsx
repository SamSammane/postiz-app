  ...
  return [
    ...(user?.allowTrial
      ? [
          {
            title: t(
              'faq_am_i_going_to_be_charged_by_trelexa',
              'Am I going to be charged by Trelexa.ai?'
            ),
            description: t(
              'faq_to_confirm_credit_card_information_trelexa_will_hold',
              'To confirm credit card information Trelexa.ai will hold $2 and release it immediately, you can cancel your subscription anytime from settings without talking to a person'
            ),
          },
        ]
      : []),
    {
      title: t(
        'faq_can_i_trust_trelexa',
        `Can I trust Trelexa.ai?`
      ),
      description: t(
        'faq_trelexa_is_proudly_open_source',
        `Trelexa.ai is proudly open-source! We believe in an ethical and transparent culture, meaning that Trelexa.ai will live forever. You can check out the entire code or use it for personal projects. To view the open-source repository, <a href="https://github.com/gitroomhq/postiz-app" target="_blank" style="text-decoration: underline;">click here</a>.`
      ),
    },
    {
      title: t('faq_what_are_channels', 'What are channels?'),
      description: t(
        'faq_trelexa_allows_you_to_schedule_posts',
        `Trelexa.ai allows you to schedule your posts between different channels.
